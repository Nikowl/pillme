        ...
        <form action="/createProduct" method="get">
            <div class="row g-2 mb-2">
                <div class="form-floating col-md-4">
                    <input type="text" name="brand" class="form-control" id="brand" placeholder="<?= $param['errors']['brand'] ?? "brand"?>"
            ...
            <div class="row g-2 mb-2">
                <div class="form-floating col-md-4">
                    <input type="text" name="codeProduct" class="form-control" id="codeProduct"
                           placeholder="<?= $param['errors']['codeProduct'] ?? "codeProduct"?>" autocomplete="off" value="<?= $param['codeProduct'] ?? "" ?>"
            ...
            <div class="row g-2 mb-2">
                <div class="form-floating col-md-4">
                    <input type="text" name="name" class="form-control" id="name" placeholder="<?= $param['errors']['name'] ?? "name"?>" autocomplete="off"
                           value="<?= $param['name'] ?? "" ?>"
